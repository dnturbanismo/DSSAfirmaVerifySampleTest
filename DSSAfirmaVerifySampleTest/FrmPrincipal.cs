...
using Util.Soap;
using DSSAfirmaVerifySampleTest.AFirmaServices;
    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void btnEnviarSolicitud_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DSSAfirmaVerify dafv = new DSSAfirmaVerify(txtIdentificador.Text, cert);

                byte[] resultado = dafv.UpgradeSignature(contenidoFirma, formatoFirma, cmbTipo.Text);
